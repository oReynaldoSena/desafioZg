...
public class POST2 {
    public static void main(String[] args) {
        try {
            // URL do endpoint do Passo 3
            String url = "https://desafio-endpoint-hashcode-n2.onrender.com/passo3";
            ...
            // Cria o JSON com o CPF e a resposta da questão
            JSONObject jsonInput = new JSONObject();
            jsonInput.put("cpf", "***.***.***-**");  //
            jsonInput.put("respostaQuestaoObjetiva", "5");  //
